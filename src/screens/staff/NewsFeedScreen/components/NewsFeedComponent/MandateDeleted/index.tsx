...
const Component12: React.FC<IComponentProps> = ({
  item: {
    deleted_by_nickname,
    client_id,
      ...
      <View style={styles.container}>
            ...
            <Text style={[{ color: theme.colors.primary }, {}]}>
              {`${
                clientName
                  ? clientName
                  : translate(
                      messages.deletedDirectDebiteMandate.scope,
                      messages.deletedDirectDebiteMandate.options,
                    )
              }`}
            </Text>
          </View>
        ...
        <View style={{ padding: theme.space.s }}>
          ...
          <Text style={{ color: 'grey' }}>
            {moment(date_deleted, 'YYYY-MM-DD HH:mm:ss').format(
              'DD/MM/YYYY hh:mm a',
            )}
          </Text>
        </View>
