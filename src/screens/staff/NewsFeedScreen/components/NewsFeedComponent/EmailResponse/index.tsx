...
const Component9: React.FC<IComponentProps> = ({ item }) => {
      ...
      <View style={styles.container}>
        <View style={{ padding: theme.space.s }}>
          <View>
            {clientName ? (
              ...
              <FormattedMessage style={{}} {...messages.receivedEmail} />
            )}
          </View>
        </View>
        ...
        <View style={{ padding: theme.space.s }}>
          <View>
            ...
            <FormattedMessage style={{}} {...messages.receivedEmailFrom} />
            <Text style={{ color: 'black' }}>{`${fromEmail}`}</Text>
