...
const Component15: React.FC<IComponentProps> = ({
            ...
            <Text style={[{ color: theme.colors.primary }, {}]}>
              {`${
                clientName
                  ? clientName
                  : translate(
                      messages.newBodyTreatmentRecord.scope,
                      messages.newBodyTreatmentRecord.options,
                    )
              }`}
            </Text>
          </View>
        ...
        <View style={{ padding: theme.space.s }}>
          <Text style={{ color: 'black' }}>
            ...
            <Text style={[{ color: theme.colors.text?.highlightedColor }, {}]}>
              {`${translate(
                messages.addedBodyTreatment.scope,
                messages.addedBodyTreatment.options,
              )}`}{' '}
              #{id}
            </Text>
          </Text>
